...
let tweetsData =
  JSON.parse(localStorage.getItem("Tweets")) || initialTweetsData
...
<div class="tweet">
    ...
    <div id="reply-input-${tweet.uuid}" class="hidden tweet-input-area">

            <textarea class="reply-textarea" placeholder="Write your reply" id="${tweet.uuid}"></textarea>
            <button class="reply-btn" data-reply-btn="${tweet.uuid}" id="reply-btn">Reply</button>
